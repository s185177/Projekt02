...
<table style="border: solid black;" width="100%" cellpadding="20">
    ...
    <tr>
        ...
        <td style="border: none;">Rigshospitalet</td> <%--Henter her Sygehus--%>
    ...
    <tr>
        ...
        <td style="border: none;">Glostrup Sygehus</td> <%--Henter her Sygehus--%>
        <td style="border: none;">15 min</td> <%--Henter her varighed--%>
        <td style="border: none;"><button type="button">V&AElig;LG</button></td>
    ...
    <tr>
        ...
        <td style="border: none;">Hvidovre Sygehus</td> <%--Henter her Sygehus--%>
        <td style="border: none;">15 min</td> <%--Henter her varighed--%>
        <td style="border: none;"><button type="button">V&AElig;LG</button></td>
